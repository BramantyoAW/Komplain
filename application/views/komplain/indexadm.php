      ...
      <p class="col-md-6" style="margin-left:740px"><font color="#FF0000"><?php echo $message;?></font></p>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <th width="120" style="text-align:left">ID Kategori</th>
                    <th width="160" style="text-align:left">Judul Komplain</th>
                    <th width="175" style="text-align:center">Tanggal & Jam</th>
                    <th width="190" style="text-align:left">Status Komplain</th>
